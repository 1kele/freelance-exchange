...
@pytest.mark.parametrize(
    ...
    [
        (1, "Сделать лого", "Нужен логотип для стартапа", 5000, OrderCategory.design, 7, 200),
        (2, "Разработать сайт", "Лендинг на React", 30000, OrderCategory.development, 14, 200),
        (3, "Написать статью", "SEO статья 3000 слов", 2000, OrderCategory.copywriting, 3, 200),
...
async def test_delete_my_order(auth_ac_customer):
    response = await auth_ac_customer.delete(
        "/orders/1"
    )
