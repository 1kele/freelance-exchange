...
async def test_register(
    ac, email, username, password, first_name, last_name, middle_name, role, status_code
):
...
async def test_login(ac, email, password, status_code, setup_blocked_user):
