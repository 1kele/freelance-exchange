...
from src.database import Base, engine_null_pool, async_session_maker_null_pool  # noqa: E402
from src.db_manager import DBManager  # noqa: E402
from src.schemas.user import AdminUserUpdate, AllRoles  # noqa: E402
...
async def register_user(setup_database):
    ...
    async with DBManager(session_factory=async_session_maker_null_pool) as db:
        await db.user.edit(
            AdminUserUpdate(role=AllRoles.admin), email="admin@gmail.com"
        )
        await db.commit()
