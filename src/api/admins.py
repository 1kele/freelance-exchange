...
from src.exceptions import (
    ...
    UserAlreadyHasRoleHTTPException,
...
async def assign_user_admin(
    user_id: int, db: DBDep, current_user: AdminDep, data: AdminUserUpdate
):
    try:
...
async def block_unblock_user(
    user_id: int, db: DBDep, current_user: AdminDep, is_blocked: bool
):
